#!/bin/bash
#SBATCH --job-name=Confidential_2000_greedy
...
# Greedy
python -u optimize_pro_plus.py --log_path raw_data/Confidential_2000.csv \
  ...
  --mut_prob 0.3 \
  --cx_prob 0.7 \
  --costs_path costs/costs_Confidential_2000.json \
