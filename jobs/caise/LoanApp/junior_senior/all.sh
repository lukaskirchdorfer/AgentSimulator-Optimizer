...
# Greedy
python -u optimize_pro_plus.py --log_path raw_data/LoanApp_junior_senior.csv \
  --case_id case_id \
  ...
  --mut_prob 0.3 \
  --cx_prob 0.7 \
  --costs_path costs_junior_senior.json \
...
# Greedy
python -u optimize_pro_plus.py --log_path raw_data/LoanApp_same_money_diff_time.csv \
  --case_id case_id \
  --activity_name activity_name \
  --resource_name resource \
  --start_timestamp start_timestamp \
  ...
  --mut_prob 0.3 \
  --cx_prob 0.7 \
  --costs_path costs_same_money_diff_time.json \
  --objectives "cost,wait" \
  --mutation_choice 0.7
